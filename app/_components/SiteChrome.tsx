...
const FOOTER_COLS = [
  ...
  { head: "Employers", links: [{ label: "Free AI chatbot", href: "/free-ai-chatbot" }, { label: "Site chat pricing", href: "/pricing/business" }, { label: "Post a role", href: "/waitlist" }, { label: "Search talent", href: "/waitlist" }] },
