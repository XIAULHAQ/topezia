...
const S: Record<string, CSSProperties> = {
  ...
  ctaTitle: { fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 17, marginBottom: 4 },
  ...
  jobTitle: { fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 17 },
  ...
  sibHead: { fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 15, marginBottom: 12 },
