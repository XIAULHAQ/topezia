...
export type Strings = {
  ...
  contactSave: string;
  contactSkip: string;
  contactThanks: (firstName: string) => string;
...
const en: Strings = {
  ...
  voiceOff: "Stop reading aloud",
  contactTitle: "Who am I talking to?",
  contactWhy: "So the team can follow up if we get cut off. We'll only use it to reply.",
  contactSave: "Save my details",
  contactSkip: "Not now",
  contactThanks: (n) => `Thanks${n ? `, ${n}` : ""} — the team has your details. Carry on asking me anything.`,
  teamLabel: (c) => `${c} team`,
...
const es: Strings = {
  ...
  voiceOff: "Dejar de leer en voz alta",
  contactTitle: "¿Con quién hablo?",
  contactWhy: "Para que el equipo pueda responderte si se corta. Solo lo usaremos para contestarte.",
  contactSave: "Guardar mis datos",
  contactSkip: "Ahora no",
  contactThanks: (n) => `Gracias${n ? `, ${n}` : ""} — el equipo tiene tus datos. Sigue preguntándome lo que quieras.`,
...
const fr: Strings = {
  ...
  voiceOff: "Arrêter la lecture",
  contactTitle: "À qui ai-je le plaisir ?",
  contactWhy: "Pour que l'équipe puisse vous répondre si la conversation se coupe. Uniquement pour vous répondre.",
  contactSave: "Enregistrer mes coordonnées",
  contactSkip: "Pas maintenant",
  contactThanks: (n) => `Merci${n ? `, ${n}` : ""} — l'équipe a vos coordonnées. Continuez à me poser vos questions.`,
...
const de: Strings = {
  ...
  voiceOff: "Vorlesen beenden",
  contactTitle: "Mit wem spreche ich?",
  contactWhy: "Damit das Team antworten kann, falls die Verbindung abbricht. Nur für die Antwort.",
  contactSave: "Daten speichern",
  contactSkip: "Jetzt nicht",
  contactThanks: (n) => `Danke${n ? `, ${n}` : ""} — das Team hat Ihre Daten. Fragen Sie mich ruhig weiter.`,
  teamLabel: (c) => `${c}-Team`,
...
const pt: Strings = {
  ...
  voiceOn: "Ler as respostas em voz alta",
  voiceOff: "Parar de ler em voz alta",
  contactTitle: "Com quem estou a falar?",
  contactWhy: "Para a equipa poder responder se a conversa cair. Só o usamos para responder.",
  contactSave: "Guardar os meus dados",
  contactSkip: "Agora não",
  contactThanks: (n) => `Obrigado${n ? `, ${n}` : ""} — a equipa tem os seus dados. Continue a perguntar.`,
...
const it: Strings = {
  ...
  voiceOn: "Leggi le risposte ad alta voce",
  voiceOff: "Smetti di leggere",
  contactTitle: "Con chi sto parlando?",
  contactWhy: "Così il team può risponderti se la chat si interrompe. Lo usiamo solo per risponderti.",
  contactSave: "Salva i miei dati",
  contactSkip: "Non ora",
  contactThanks: (n) => `Grazie${n ? `, ${n}` : ""} — il team ha i tuoi dati. Continua pure a chiedermi qualsiasi cosa.`,
  teamLabel: (c) => `team ${c}`,
...
const nl: Strings = {
  ...
  voiceOn: "Antwoorden voorlezen",
  voiceOff: "Stoppen met voorlezen",
  contactTitle: "Met wie spreek ik?",
  contactWhy: "Zodat het team kan reageren als het gesprek wegvalt. Alleen om je te antwoorden.",
  contactSave: "Mijn gegevens opslaan",
  contactSkip: "Nu niet",
  contactThanks: (n) => `Bedankt${n ? `, ${n}` : ""} — het team heeft je gegevens. Stel gerust nog meer vragen.`,
  teamLabel: (c) => `${c}-team`,
