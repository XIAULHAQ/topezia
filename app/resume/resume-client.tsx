...
export default function ResumeClient() {
  ...
  // Marks the sheet's ancestor chain for the print stylesheet and fits it to
  // a whole number of pages on beforeprint — see lib/resume/print-sheet.ts.
...
/**
 * Screen-layout CSS only — the print rules live in lib/resume/print-sheet.ts
 * now, shared with the tailor-resume slide-in panel (app/job/[id]/TailorPanel.tsx).
 */
const SCREEN_CSS = `
